...
<img width="751" height="268" alt="{49E2E0A0-8005-473C-A1FA-6B130751604A}" src="https://github.com/user-attachments/assets/918ee8da-396e-4ad9-a1d7-55e3948e2f16" />
...
**2️⃣ 해결 과정** <br>
  ...
  - SealedSecret 적용 (backend-sealedsecret.yaml)<br>
...
**1️⃣ 문제 상황** <br>
  ...
  - 또한 WebSocket의 경우 **HTTP/1.1 Upgrade 헤더**가 없으면 “업그레이드 불가(HTTP/1.0 fallback)”로 간주되어 연결 실패.<br>
